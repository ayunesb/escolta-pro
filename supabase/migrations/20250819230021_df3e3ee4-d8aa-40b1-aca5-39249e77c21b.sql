...
-- Insert freelancer guard profiles (using offline as availability_status)
INSERT INTO guards (id, user_id, city, hourly_rate, skills, rating, active, availability_status, photo_url)
VALUES 
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', gen_random_uuid(), 'Playa del Carmen', 150.00, '{"armed": true, "unarmed": true, "vehicle": true, "languages": ["Spanish", "English"], "experience_years": 8, "specialties": ["VIP Protection", "Event Security"]}', 4.8, true, 'offline', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face'),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', gen_random_uuid(), 'Cancun', 140.00, '{"armed": true, "unarmed": true, "vehicle": false, "languages": ["Spanish", "English", "French"], "experience_years": 5, "specialties": ["Personal Protection", "Corporate Security"]}', 4.9, true, 'offline', 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=300&h=300&fit=crop&crop=face'),
  ('ffffffff-ffff-ffff-ffff-ffffffffffff', gen_random_uuid(), 'Tulum', 160.00, '{"armed": true, "unarmed": true, "vehicle": true, "languages": ["Spanish"], "experience_years": 12, "specialties": ["Executive Protection", "Residential Security"]}', 4.7, true, 'offline', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&h=300&fit=crop&crop=face');
